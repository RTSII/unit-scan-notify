          ...
          <div className="py-2 sm:py-4">
                ...
                <div key={input.buildingId} className="p-3 sm:p-4 bg-black/40 border border-vice-cyan/30 rounded-lg space-y-2">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      placeholder="0000"
                      maxLength={4}
                      className="bg-black/20 border-vice-cyan/30 text-white text-lg sm:text-xl text-center font-mono tracking-widest h-10 sm:h-11"
                    />
                  </div>
                </div>
              ))}
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-2 sm:gap-3 pt-3 sm:pt-4">
              <Button
                ...
                variant="outline"
                className="border-vice-cyan/30 text-white hover:bg-white/10 w-full sm:w-auto h-9 sm:h-10 text-sm"
              >
                Cancel
              </Button>
              <Button
                onClick={savePins}
                disabled={saving}
                className="bg-vice-cyan hover:bg-vice-cyan/80 text-black w-full sm:w-auto h-9 sm:h-10 text-sm"
              >
                {saving ? (
                  <>
