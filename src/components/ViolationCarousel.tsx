        ...
        <AnimatePresence mode="wait">
          {isPopoverOpen && activeForm && (
            <>
              ...
              <div 
                className="fixed inset-0 flex items-start justify-center z-50 p-4 pt-[160px] sm:pt-[140px] pointer-events-none"
                style={{ touchAction: 'auto' }}
                onTouchStart={(e) => e.stopPropagation()}
                onTouchMove={(e) => e.stopPropagation()}
                onTouchEnd={(e) => e.stopPropagation()}
              >
                <motion.div
                  ...
                  className="w-full max-w-2xl max-h-[calc(85vh-160px)] sm:max-h-[calc(85vh-140px)] p-0 bg-gradient-to-br from-vice-purple/95 via-black/95 to-vice-blue/95 border-2 border-vice-cyan backdrop-blur-xl rounded-2xl shadow-2xl pointer-events-auto overflow-hidden"
